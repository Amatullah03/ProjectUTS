						...
						<form action="../ProjectUTS_Semester2/../controller/proses.php?aksi=tambah" method="post">
							<div class="row" style="padding-top: 10px;">
								<div class="col-md-12 col-sm-12">
                                    <center><a style="color: #d99879; font-family: 'Pattaya', sans-serif; font-size: 45px;">
									Login in to BacaYuk!</a></center>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 col-sm-12">
                                <a href="./LoginGoogle/index.php"><img src="LoginButton.png" width="535px" height="120px"></a>
								</div>
                            </div>
                            <div class="row">
								<div class="col-md-12 col-sm-12">
                                    <center><a style="color: #d99879;font-family: 'Pattaya', sans-serif;
                                    font-size: 30px;">----------------------------OR----------------------------</a></a></center>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 col-sm-12">
