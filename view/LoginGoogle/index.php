...
if(!isset($_SESSION['access_token'])){
    $login_button = '<a href="'.$google_client->createAuthUrl().'"><img src="LoginButton.png" width="350px"
    height="80px" style=""></a>';
}
...
<body>
    ...
    <div class="container" style="margin-bottom: 50px;">
        <div class="row">
            <div class="col-3">
                <img src="gambar10.jpg" alt="Gambar 10" width="150px" height="200px">
            </div>
            <div class="col-3">
                <img src="gambar11.jpg" alt="Gambar 11" width="150px" height="200px">
            </div>
            <div class="col-3">
                <img src="gambar12.jpg" alt="Gambar 12" width="150px" height="200px">
            </div>
            <div class="col-1">
                <img src="gambar13.jpg" alt="Gambar 13" width="150px" height="200px">
            </div>
        </div>
    </div>
